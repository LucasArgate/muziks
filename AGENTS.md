...
- **Quando houver implementação:** seguir [`docs/tech/ESPECIFICACAO-FRONTEND.md`](docs/tech/ESPECIFICACAO-FRONTEND.md) (PWA, React, TypeScript, Tailwind, shadcn) e [`docs/tech/ATOMIC-DESIGN.md`](docs/tech/ATOMIC-DESIGN.md) para estrutura de componentes.
